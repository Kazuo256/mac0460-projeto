...
\section{Compilando e rodando o projeto}
  ...
  \subsection{Compilação do projeto}
    ...
    ou a pasta onde fica o pacote instalado do OpenCV, que é a pasta
    \verb$/usr/local$. Testamos porém apenas com o OpenCV compilado, então
    ...
    encontrados em \verb$/opencv/bin$,
